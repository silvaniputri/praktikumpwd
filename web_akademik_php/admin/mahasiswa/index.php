    ...
    <table id="list-data" class="display">
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <button class="button-edit" onclick="show-modal(<?php echo $i?>)">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form name="input" method="post" action="mahasiswa/mahasiswa_input.php">
        ...
        <label for="fnama">Nama</label>
        <input type="text" id="fnama" name="nama" placeholder="Nama" pattern="[a-zA-Z ]+" title="Masukkan Hanya Huruf" required>
        <label for="ftingkat">Tingkat</label>
        ...
        <input type="password" id="fpass" name="password" pattern="[a-zA-Z0-9]+" title="Masukkan Hanya Alphanumeric" required>
        <input type="submit">
      </form>
    </div>
  </div>

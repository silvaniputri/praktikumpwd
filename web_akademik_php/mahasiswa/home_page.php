...
<!DOCTYPE html>
    <head>
        ...
        <!-- File stylesheet ini mengandung gaya (stles) yang diperlukan untuk mengatur tata letak dan 
        ...
        <!-- <script src="../style/datatables.min.css"></script> -->
...
<body>
    ...
    <div class="container">
        <div id="page-h" class="page-header">
            <div class="page-logo">
                <img class src="../assets/image/stmik.png"/>
            </div>
